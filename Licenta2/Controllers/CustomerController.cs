...
namespace Licenta2.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            if (MemoryCache.Default["Category"] == null)
            {
                MemoryCache.Default["Category"] = _context.Category.ToList();
            }

            var category = MemoryCache.Default["Category"] as IEnumerable<Category>;
